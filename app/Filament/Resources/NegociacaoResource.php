                ...
                /*
                    ...
                    ->schema([
                        MultiSelect::make('produtos')
                            ...
                            // marca itens já vinculados no edit
                            ->afterStateHydrated(function ($state, $set, $livewire) {
                                if ($livewire->record) {
                                    $set('produtos', $livewire->record->produtos->pluck('id')->toArray());
                                }
                            }),
                    ]),
                */
                        ...
                        Repeater::make('negociacaoProdutos')
                            ...
                            ->schema([
                                Select::make('produto_id')
                                    ->label('Produto')
                                    ->options(fn () => Produto::all()
                                        ->pluck('nome_composto', 'id')
                                        ->toArray()
                                    )
                                    ->searchable()
                                    ->required(),
